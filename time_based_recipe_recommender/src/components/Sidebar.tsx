...
import { FaHome, FaUtensils, FaRobot, FaInfoCircle } from 'react-icons/fa';

const navItems = [
  { href: '/', label: 'Home', icon: FaHome },
  { href: '/recipe-recommender', label: 'Recipe Recommender', icon: FaUtensils },
  { href: '/ai-implementation', label: 'AI Implementation', icon: FaRobot },
];
